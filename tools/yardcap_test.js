...
const REPLY = {
  ...
  getProdPlanData: () => ({ updated: '2026-09-18 08:00', error: null,
    daily: { error: null, 日付ラベル: '9月18日', fileName: '工場別当日計画(26.9.18).xlsx',
      ...
      合計: 1900, 人員: 24,
      rows: [], 工場: [
        { 工場: '50k', 計画数: 1000, 基準: '処理', 社員: 18, 協力: 8,
          工程: [{ 工程: '加工', 計画数: 1000 }, { 工程: '品質', 計画数: 1000 },
                 { 工程: '処理', 計画数: 1000 }] },
        { 工場: '20k', 計画数: 900, 基準: '処理', 社員: 3, 協力: 1,
          工程: [{ 工程: 'コイル', 計画数: 2600 }, { 工程: '加工', 計画数: 1200 },
                 { 工程: '処理', 計画数: 900 }] },
        { 工場: '特殊', 計画数: 0, 基準: '加工', 社員: 1, 協力: 1,
          工程: [{ 工程: '加工', 計画数: 0 }] },
      ] },
...
(async () => {
  ...
  /* ---- 生産計画 ---- */
  {
    ...
    chk('★当日は処理の本数を出す（コイル2,600でも加工1,200でもなく900）',
      /20k　処理 \| 900 本/.test(t), t);
    chk('50kも処理の1,000', /50k　処理 \| 1,000 本/.test(t), t);
    chk('★処理が無い工場はどの工程かを添える（特殊＝加工）',
      /特殊　加工 \| 0 本/.test(t), t);
    chk('★工程ごとの内訳も出す（どこから来た数字か分かるように）',
      /コイル 2,600・加工 1,200・処理 900/.test(t), t);
