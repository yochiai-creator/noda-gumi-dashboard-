...
(async () => {
  ...
  await page.addInitScript(() => {
    ...
    const DATA = {
      ...
      getArmShipPlan: { ...E, total: 0, days: [], byKind: [], sourceName: null, snapshotAt: null, stale: false, pdfUrl: null, pdfName: null },
      getArmMonthlyData: { ...E, months: [], kinds: [], total: 0, startMonth: null, today: null, currentAll: null, sourceName: null, harvestedAt: null },
